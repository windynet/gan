...
public class RtspConnectionMediaSession implements MediaSession<RtspClient> {

    RtspClient mRtspConnection;

    public RtspConnectionMediaSession(RtspClient rtspConnection){
